           ...
           <div id="content_login">
              ...
              <table width="330px">
                ...
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="hplQuenmatkhau" runat="server" NavigateUrl="QuenMatKhau.aspx?url=ql">Quên mật khẩu ?</asp:HyperLink><br />
                        <asp:HyperLink ID="hplDangki" runat="server" NavigateUrl="DangKy.aspx?url=dk">Chưa có tài khoản ?</asp:HyperLink>
